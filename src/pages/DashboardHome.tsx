...
import {
  ...
  Target, Crown, Info, Mail, Shield, ArrowRight, Trophy
} from 'lucide-react';
    ...
    <main className="page-section">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-medium text-slate-600 dark:text-slate-400">Win Rate</p>
          ...
          <Card>
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-medium text-slate-600 dark:text-slate-400">Total Profit</p>
          ...
          <Card>
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div>
                <p className="text-xs font-medium text-slate-600 dark:text-slate-400">Active Predictions</p>
      ...
      <section aria-labelledby="picks-heading">
        <header className="section-header mb-4">
          <h2 id="picks-heading" className="text-lg font-bold text-slate-900 dark:text-white">
            🔥 Today&apos;s Top Picks
          </h2>
          <Button variant="ghost" size="sm" onClick={() => navigate('/predictions')} className="w-fit">
            View All <ArrowRight className="w-4 h-4 ml-1" />
          </Button>
        </header>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {todayPredictions.map(pred => (
            <PredictionCard key={pred.id} prediction={pred} onUpgrade={() => navigate('/premium')} />
          ))}
        </div>
      </section>
      ...
      <section aria-labelledby="nav-heading">
        <header className="section-header mb-4">
          <h2 id="nav-heading" className="text-lg font-bold text-slate-900 dark:text-white">Quick Navigation</h2>
        </header>
      ...
      <section aria-labelledby="summary-heading">
        <h2 id="summary-heading" className="sr-only">Results and Platform Summary</h2>
        <div className="grid sm:grid-cols-2 gap-6">
          <Card>
            <CardContent className="p-5">
              ...
              <Button variant="ghost" size="sm" className="w-full mt-3" onClick={() => navigate('/results')}>
          ...
          <Card>
            <CardContent className="p-5">
              ...
              <Button variant="ghost" size="sm" className="w-full mt-3" onClick={() => navigate('/about')}>
      ...
      {user?.plan !== 'premium' && (
        <section className="overflow-hidden">
          <Card className="bg-gradient-to-br from-slate-900 to-slate-800 border-none text-white relative">
            <div className="absolute top-0 right-0 -mt-8 -mr-8 w-40 h-40 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full blur-3xl opacity-30" aria-hidden="true" />
            <div className="absolute bottom-0 left-0 -mb-8 -ml-8 w-32 h-32 bg-blue-600 rounded-full blur-3xl opacity-20" aria-hidden="true" />
